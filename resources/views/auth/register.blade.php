...
rounded-lg shadow-lg">
    ...
    <form class="mt-4" method="POST" action="">
        ...
        <input type="text" class="border-gray-200 rounded-md bg-gray-200 w-full
        ...
        <input type="email" class="border-gray-200 rounded-md bg-gray-200 w-full
        ...
        <input type="password" class="border-gray-200 rounded-md bg-gray-200 w-full
